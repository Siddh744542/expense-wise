    ...
    <div className="h-full flex flex-col gap-2 bg-white p-5 shadow-md rounded-lg h-fit-content">
      ...
      <div className="flex flex-col gap-0.5">
        ...
        <div className="flex justify-between ">
          ...
          <div className="text-right items-center">
            <p className="text-sm font-semibold">{mostSpentCategory.name}</p>
      ...
      <div className="flex flex-col gap-0.5">
        ...
        <div className="flex justify-between ">
          ...
          <div className="text-right items-center">
            <p className="text-sm m-0 font-semibold">{highestIncomeSource.name}</p>
            <p className="text-xs m-0 text-gray-500 whitespace-nowrap">
      ...
      <hr className="border-gray-300" />
      <div className="flex justify-between items-center ">
        <p className="text-gray-600 text-sm font-semibold text-sm">Savings</p>
